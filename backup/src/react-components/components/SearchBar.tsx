  ...
  return (
    <div className={containerStyles}>
      <div className="relative">
        <MagnifyingGlassIcon className="pointer-events-none absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-sky-400/60" />
        <input
          type="text"
      ...
      {showSearchResults && searchQuery && filteredTeams.length === 0 && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-navy-900/95 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl z-50 p-6">
          <div className="text-center">
            <MagnifyingGlassIcon className="h-8 w-8 text-white/40 mx-auto mb-2" />
