        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                ...
                >
                    ...
                    <PlusIcon className="h-8 w-8 text-white/80 group-hover:text-white transition-colors" />
                </Link>
                <Link
                    to="/join-league"
                ...
                >
                    ...
                    <UserGroupIcon className="h-8 w-8 text-white/60 group-hover:text-white transition-colors" />
                </Link>
            </div>
