...
function DashboardContent() {
    ...
    // Convert schedule data to the format expected by GameCard - EXACT COPY from make-picks
    const games = useMemo(() => {
                ...
                <AnimatedContent animation="scale" delay={75}>
                    <div className="relative bg-navy-900/50 border border-white/10 rounded-xl p-6 hover:bg-navy-900/60 hover:border-white/20 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl glass-transition">
                        <div className="flex items-center justify-between">
                            ...
                            <TrophyIcon className="h-8 w-8 text-sunset-500" />
                        </div>
                    </div>
                </AnimatedContent>
                ...
                <AnimatedContent animation="scale" delay={150}>
                    <div className="relative bg-navy-900/50 border border-white/10 rounded-xl p-6 hover:bg-navy-900/60 hover:border-white/20 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl glass-transition">
                        <div className="flex items-center justify-between">
                            ...
                            <ChartBarIcon className="h-8 w-8 text-sunset-500" />
                        </div>
                    </div>
                </AnimatedContent>
                ...
                <AnimatedContent animation="scale" delay={225}>
                    <div className="relative bg-navy-900/50 border border-white/10 rounded-xl p-6 hover:bg-navy-900/60 hover:border-white/20 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl glass-transition">
                        <div className="flex items-center justify-between">
                            ...
                            <ChartPieIcon className="h-8 w-8 text-sunset-500" />
                        </div>
                    </div>
                </AnimatedContent>
                ...
                <AnimatedContent animation="scale" delay={300}>
                    <div className="relative bg-navy-900/50 border border-white/10 rounded-xl p-6 hover:bg-navy-900/60 hover:border-white/20 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl glass-transition">
                        <div className="flex items-center justify-between">
                            ...
                            <ListBulletIcon className="h-8 w-8 text-sunset-500" />
                        </div>
                    </div>
                </AnimatedContent>
            </div>
                ...
                <div className="bg-white/[0.03] backdrop-blur-lg border border-white/10 rounded-xl p-6 mb-8 glass-transition">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <TrophyIcon className="h-8 w-8 text-white/80 group-hover:text-white transition-all duration-300 group-hover:scale-110" />
                        </Link>
                        <Link
                            to="/join-league"
                        ...
                        >
                            ...
                            <ListBulletIcon className="h-8 w-8 text-white/60 group-hover:text-white transition-all duration-300 group-hover:scale-110" />
                        </Link>
                    </div>
                </div>
            </AnimatedContent>
